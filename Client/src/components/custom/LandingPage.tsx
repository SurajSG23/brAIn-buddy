    ...
    <div className="bg-[#1A1F2C] min-h-screen w-full">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <div className="lg:w-1/2 mb-12 lg:mb-0">
              ...
              <TextGenerateEffect
                ...
                words="Upload your study materials and get instant AI-powered answers
              ...
              <Button className="bg-orange-500 hover:bg-orange-600 text-white cursor-pointer p-6 text-lg rounded-xl flex items-center shadow-lg shadow-orange-500/20 hover:shadow-orange-500/30 transition-all">
                <FaGoogle className="" />
                Sign in with Google
              </Button>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#1A1F2C] to-gray-900">
        <div className="container mx-auto px-6 text-center">
          ...
          <Button className="bg-orange-500 m-auto hover:bg-orange-600 text-white cursor-pointer p-6 text-lg rounded-xl flex items-center shadow-lg shadow-orange-500/20 hover:shadow-orange-500/30 transition-all ">
            <FaGoogle className="" />
            Sign in with Google
          </Button>
        </div>
